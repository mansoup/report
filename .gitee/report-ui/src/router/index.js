...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'mapreport', name: 'mapreport', component: () => import('@/views/report/mapreport/index'), meta: { title: '地图报表', icon: 'iconliebiao', keepAlive: true, requireAuth: true, permission: 'excelManage'} },//@soup  add 2021/12/3
    ]
  },
  {
