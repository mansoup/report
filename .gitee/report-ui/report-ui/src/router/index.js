...
export const constantRouterMap = [
  ...
  { path: '/threeD', component: () => import('@/views/threeD_Bookstore/index'), hidden: true },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'report', name: 'reportIndex', component: () => import('@/views/report/report/index'), meta: { title: '报表管理', icon: 'iconnavicon-ywcs', keepAlive: true, requireAuth: true, permission: 'reportManage'} },
      {
        path: 'projects',
        name: 'projects',
       // component: {render(c) { return c('router-view') }},//解决三级路由不跳转原因
        component:() => import('@/views/projectMange/index'),//解决三级路由不跳转原因
        ...
        // children:[
        //   { path: 'project', name: 'project', component: () => import('@/views/projectMange/index'), meta: { title: '工程总表', icon: 'iconchufaqipeizhi-hui', keepAlive: true, requireAuth: true, permission: 'projectManage'}, },
        //   { path: 'projectDetail', name: 'projectDetail', component: () => import('@/views/projectMange/tables/projectDetail'), meta: { title: '工程简表', icon: 'iconchufaqipeizhi-hui', keepAlive: true, requireAuth: true, permission: 'projectManage'}, },
        //   { path: 'supervisor', name: 'supervisor', component: () => import('@/views/projectMange/tables/supervisor'), meta: { title: '负责人表', icon: 'iconchufaqipeizhi-hui', keepAlive: true, requireAuth: true, permission: 'projectManage'}, },
        // ]
      },
      ...
      { path: 'mapreport', name: 'mapreport', component: () => import('@/views/report/mapreport/index'), meta: { title: '地图报表', icon: 'iconzhongguoditu', keepAlive: true, requireAuth: true, permission: 'bigScreenManage'}, },//@soup  add 2022/1/16
      { path: 'threebook', name: 'threebook', component: () => import('@/views/threeD_Bookstore/index'), meta: { title: '3d书柜', icon: 'iconzhongguoditu', keepAlive: true, requireAuth: true, permission: 'bigScreenManage'}, },//@soup  add 2022/1/16
  ...
  {path:'/report/projects/projectApproval',component:()=>import('@/views/projectMange/tables/projectApproval'),hidden: true, meta: { requireAuth: true }},
  {path:'/report/projects/supervisor',component:()=>import('@/views/projectMange/tables/supervisor'),hidden: true, meta: { requireAuth: true }},
  {path:'/report/projects/QReditable/:id/:accessKey',component:()=>import('@/views/projectMange/components/QReditable'),hidden: true, meta: { requireAuth: true }},
  /*
  {
