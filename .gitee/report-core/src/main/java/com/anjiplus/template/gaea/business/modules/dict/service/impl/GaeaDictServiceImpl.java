...
public class GaeaDictServiceImpl implements GaeaDictService {
    ...
    public List<KeyValue> select(String dictCode, String language) {
        ...
        //缓存字典Key
        String dictKey
                = GaeaKeyConstant.DICT_PREFIX  + language + GaeaConstant.REDIS_SPLIT + dictCode;
    ...
    /**
     * @soup  wrapper是mybits plus 用于封装方便sql查询 https://www.cnblogs.com/javagg/p/12654305.html 2022/1/4
     * @param language
     * @return
     */
