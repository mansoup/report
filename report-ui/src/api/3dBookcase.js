import {TWEEN} from "./Tween";//导入的是本地Tween.js
import router from "../router/index"
 ...
 var ThreeD = {
    ...
    draw: function() {
        ...
        var bookPics = [
            [],[],[],
            ['/src/views/threeD_Bookstore/img/bookfront2.jpg','/src/views/threeD_Bookstore/img/bookback2.jpg','/src/views/threeD_Bookstore/img/shuji2.jpg'],
            ['/src/views/threeD_Bookstore/img/bookfront3.jpg','/src/views/threeD_Bookstore/img/bookback3.jpg','/src/views/threeD_Bookstore/img/shuji3.jpg'],
            ['/src/views/threeD_Bookstore/img/bookfront4.jpg','/src/views/threeD_Bookstore/img/bookback4.jpg','/src/views/threeD_Bookstore/img/shuji4.jpg']
        ]
    ...
    createBookcase: function(width, height, depth, position={x:0,y:0,z:0}, floorNum=3){
        ...
        var bookcase_mat = new THREE.MeshPhongMaterial( {
            map: THREE.ImageUtils.loadTexture('/src/views/threeD_Bookstore/img/wood.jpg'),
        });
    ...
    createBook: function(width,height,depth,position,bookPic=[]){
        var material1 = new THREE.MeshPhongMaterial( {
            map: THREE.ImageUtils.loadTexture('/src/views/threeD_Bookstore/img/bookside.jpg')});
        var material2 = new THREE.MeshPhongMaterial({
            map: THREE.ImageUtils.loadTexture(bookPic[2]||'/src/views/threeD_Bookstore/img/shuji.jpg')});
        var material3 = new THREE.MeshPhongMaterial({
            map: THREE.ImageUtils.loadTexture('/src/views/threeD_Bookstore/img/bookside2.jpg')});
        var material4 = new THREE.MeshPhongMaterial({
            map: THREE.ImageUtils.loadTexture('/src/views/threeD_Bookstore/img/bookside2.jpg')});
        var material5 = new THREE.MeshPhongMaterial({
            map: THREE.ImageUtils.loadTexture(bookPic[0]||'/src/views/threeD_Bookstore/img/bookfront1.jpg')});
        var material6 = new THREE.MeshPhongMaterial({
            map: THREE.ImageUtils.loadTexture(bookPic[1]||'/src/views/threeD_Bookstore/img/bookback1.jpg')});
    ...
    showBook: function(book_box){
        ...
        if(!(book_box.isShow||this.bookLocked)){
            ...
            var tween2 = new TWEEN.Tween(book_box.position).to({
                x: 0,
                y: -1*height/2,
            }, 500).easing(TWEEN.Easing.Cubic.Out);//设置缓动算法，就是动画速度
    ...
    returnBook: function(book_box){
        ...
        if(book_box.isShow&&(!this.bookLocked)){
            ...
            //这里需要判断有没有登录过吧，然后再跳转而且鼠标指定某个书跳转某个链接
            router.push("/login");
        }
    },
